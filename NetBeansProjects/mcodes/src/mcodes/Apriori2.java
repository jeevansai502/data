...
public class Apriori2 extends Observable {

    public static void main(String[] args) throws Exception {
        Apriori2 ap = new Apriori2(args);
    }
    ...
    public Apriori2(String[] args, Observer ob) throws Exception {
        usedAsLibrary = true;
        configure(args);
        this.addObserver(ob);
        go();
    ...
    public Apriori2(String[] args) throws Exception {
        configure(args);
        go();
    }
