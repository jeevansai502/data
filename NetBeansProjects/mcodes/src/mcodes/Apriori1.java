...
public class Apriori1 extends Observable {


    public static void main(String[] args) throws Exception {
        Apriori1 ap = new Apriori1(args);
    }
    ...
    public  Apriori1(String[] args, Observer ob) throws Exception
    {
    	usedAsLibrary = true;
    	configure(args);
    	this.addObserver(ob);
     ...
     */
    public  Apriori1(String[] args) throws Exception
    {
        configure(args);
        go();
    }
